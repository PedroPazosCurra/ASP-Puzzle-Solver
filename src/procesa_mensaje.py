...
prompt = "Blends tobacco is smoked at the fourth house."

contexto = "You're a Natural Language to Answer Set Programming translator machine. You have to answer with only the result like the provided iterations and nothing more. Do not reply with a sentence, only with the output code. Don't explain the result and don't say anything else that the result.\n \
            Input: John is hungry.\n\
            Output: hungry(john).\n\
            Input: The house is red.\n\
            Output: color(red, house).\n\
